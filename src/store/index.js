...
const store = createStore({
	...
	state: () => ({
		...
		items: [
			...
			{ type: 'contacts', name:'Dwight LaGrone', title:"GIS Manager", employer:'City of Sherman', address:'405 N Rusk St', city:'Sherman, Tx 75090', phone:'(903) 892-7310', email:'mailto:dwightl@cityofsherman.com' },
			...
			{ type: 'infographics', name: 'At Risk Population', url: 'https://experience.arcgis.com/experience/068d1053b9cb499b9d1f1047930c4686/' },
			{ type: 'infographics', name: 'Community Profile', url: 'https://experience.arcgis.com/experience/ab26267db2d348c98718a01213a414b0/?draft=true' },
			{ type: 'infographics', name: 'Coronavirus Planning', url: 'https://experience.arcgis.com/experience/449926e4cf1f4df8b42995a1a5ea3e51/' },
			{ type: 'infographics', name: 'Demographic Summary', url: 'https://experience.arcgis.com/experience/875fc49140eb457caadda7306d7105ec/e' },
			{ type: 'infographics', name: 'Employment Overview', url: 'https://experience.arcgis.com/experience/585123d5273844c7a2a961d492a8f6b0/' },
			{ type: 'infographics', name: 'Health Care & Insurance', url: 'https://experience.arcgis.com/experience/dff2ef170bdb4b3aa4444438036631b8/' },

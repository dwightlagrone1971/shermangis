...
const store = createStore({
	...
	state: () => ({
		...
		items: [
			...
			{ type: 'gisdownloads', name: 'Points', to: '/points', text: "Address Points, Control Points, Parks & Recreation, Points of Interest, Sherman Schools & Traffic Counts" },
			{ type: 'gisdownloads', name: 'Lines', to: '/lines', text: "Road Centerlines & Pavement Edge" },
			{ type: 'gisdownloads', name: 'Polygons', to: '/polygons', text: "Building Footprints, City Limits, Parcels, Council Districts, E.T.J. & Future Landuse" },
			...
			{ type: 'lines', name: 'Traffic Counts', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::trafficcounts/about' },
			{ type: 'lines', name: 'Pavement Edge', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::pavement-edge/about' },
			...
			{ type: 'points', name: 'Address Points', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::address-points/about' },
			{ type: 'points', name: 'Control Points', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::control-points/about' },
			{ type: 'points', name: 'Parks & Recreation', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::parks-and-recreation/about' },
			{ type: 'points', name: 'Points of Interest', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::points-of-interest/about' },
			{ type: 'points', name: 'Sherman Schools', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::sherman-schools-1/about' },
			{ type: 'points', name: 'Traffic Counts', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::trafficcounts/about' },
			{ type: 'polygons', name: 'Building Footprints', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::building-footprints/about' },
			{ type: 'polygons', name: 'City Limits', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::city-limits/about' },
			{ type: 'polygons', name: 'City Parcels', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::city-parcels/about' },
			{ type: 'polygons', name: 'Council Districts', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::council-districts/about' },
			{ type: 'polygons', name: 'E.T.J.', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::extra-territorial-jurisdiction/about' },
			{ type: 'polygons', name: 'Future Landuse', url: 'https://data-cityofsherman.opendata.arcgis.com/datasets/cityofsherman::future-landuse-plan/about' },
		],
	}),

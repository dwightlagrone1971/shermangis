<template>
  <div class="m-auto w-10/12 mt-6 mb-10 2xl:w-6/12" style="background-color: #f8f8f8;">
    <p class="m-auto mb-6 2xl:py-6 text-xl font-bold" style="color: #4a4a4a;">
 ...
 <div class="m-auto grid grid-cols-1 lg:grid-cols-3">
   <div
     ...
     class="m-auto mb-6 pb-10 w-72 2xl:w-72 h-12 inline-block transition transform hover:-translate-y-3 motion-reduce:transition-none motion-reduce:transform-none">

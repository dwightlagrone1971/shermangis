<template>
  <div>
    <h1 class="text-5xl mt-12 mb-12 font-bold 2xl:mt-24 2xl:mb-20" style="color: #4a4a4a">GIS Polygon Features</h1>
...
export default {
  setup() {
    ...
    const items = computed(() => store.getters.getItems('polygons'))
